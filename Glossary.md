...
Правильное представление множества | Valid set representation | |
(в описаниях функций калькулятора) | |
Отображение данных в виде диаграммы | Chart data view | |
Константа | Intercept | |
Не-событие | Negative event | |
...
5. Непонятная ситуация с you. Нашли аналогичные варианты в Excel и Knime с you (Do you really want to…?) И все же в некоторых ситуациях не приветствуется. Необходимо формировать четкое правило по стилистике употребления you.
